    ...
    >
      ...
      {editorMode === "edit" ? (
        <textarea
          ...
          className="textarea text-base bg-transparent border-0 shadow-none resize-none overflow-hidden w-full min-h-96 leading-relaxed focus:bg-transparent focus:shadow-none focus:outline-none p-0"
        />
      ) : editorMode === "view" ? (
